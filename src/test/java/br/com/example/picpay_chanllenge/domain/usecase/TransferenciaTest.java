...
class TransferenciaTest {
    ...
    void transfereSuccessfull() {
        ...
        verify(userRepository, times(1)).withdraw(user1.Id(), 100L);
        verify(userRepository, times(1)).deposit(user2.Id(), 100L);
    ...
    void transfereFailWhenAuthorizationFails() {
        ...
        verify(userRepository, never()).withdraw(user1.Id(), 100L);
        verify(userRepository, never()).deposit(user2.Id(), 100L);
